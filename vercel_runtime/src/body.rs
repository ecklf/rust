...
///
/// ```
/// assert!(match vercel_runtime::Body::from("text") {
///   vercel_runtime::Body::Text(_) => true,
///   _ => false
/// })
/// ```
///
...
///
/// ```
/// assert!(match vercel_runtime::Body::from("text".as_bytes()) {
///   vercel_runtime::Body::Binary(_) => true,
///   _ => false
/// })
/// ```
///
...
///
/// ```
/// assert!(match vercel_runtime::Body::from(()) {
///   vercel_runtime::Body::Empty => true,
///   _ => false
/// })
/// ```
